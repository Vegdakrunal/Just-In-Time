    ...
    <div class="container">
      <div class="row">
        <div class="col-md-offset-4 col-md-4">
          <!-- <img class="log" src="images/logo_f.png"> -->
          <h1 class="heading" align=center style="font-weight: bold !important; font-family: Times New Roman, Times, serif; font-size:50px; color: black;">Just In Time</h1>
          <br><br><br>
          <!-- Form Start -->
