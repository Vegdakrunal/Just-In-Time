...
<head>
    ...
    <link rel="icon" href="admin/images/logo_f.png" type="image/x-icon">   <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
                  ...
                  while($row = mysqli_fetch_assoc($result)) {
                    if($row['logo'] == ""){
                      ...
                      // echo '<a href="index.php" id="logo"><img src="admin/images/'. $row['logo'] .'"></a>';
                        echo '<a href="index.php"><h1 style="font-weight: bold !important; font-family: Times New Roman, Times, serif; font-size:50px; color: black;">'.$row['websitename'].'</h1></a>';
                    }
                  }
                }
                ?>
